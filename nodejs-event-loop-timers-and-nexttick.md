> * 原文地址：[The Node.js Event Loop, Timers, and process.nextTick()](https://nodejs.org/en/docs/guides/event-loop-timers-and-nexttick/)
> * 译文出自：[Breword](https://www.breword.com)
> * 译者：Breword 官方翻译小组

# The Node.js Event Loop, Timers, and `process.nextTick()`[](#the-node-js-event-loop-timers-and-process-nexttick)
...
## Why use `process.nextTick()`?[](#why-use-process-nexttick)
